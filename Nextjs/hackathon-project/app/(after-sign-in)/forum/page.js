  ...
  return (
    <div>
      <div className="py-10 px-10 mx-auto text-center flex items-center max-w-5xl">
        ...
        <input
          className="rounded-lg w-full h-10 px-4 text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          type="text"
        ...
        ></input>
        <button
          className="bg-blue-500 rounded w-20 h-9 py-4 px-2 mx-3 my-3 flex items-center justify-center hover:scale-110 transition-transform duration-300"
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col flex-1 mx-8">
          <div className="h-70 flex flex-col items-center">
            ...
            <button
              className="bg-blue-500 rounded w-20 h-7 py-4 px-5 mx-4 my-4 flex items-center hover:scale-110 transition-transform duration-300"
          ...
          <div className="container mx-auto p-4">
            {questions &&
              questions.map((question) => (
                <div
                  key={question.qid}
                  className="p-6 mb-10 text-left border border-gray-300 rounded-lg bg-[#001f3f] hover:scale-105 transition-transform duration-200"
                >
                  <div className="flex flex-row items-center">
                    <div
                      className="rounded-full w-10 h-10 bg-cover bg-center m-1"
                  ...
                  <div className="text-left border-b p-3 mr-40 bg-[#008080] rounded-xl">
                    ...
                    <p className="text-sm text-black text-right">
                      {timeAgo(question.time)}
                    </p>
                  </div>

                  <button
                    className="bg-yellow-500 rounded w-15 h-4 p-3 m-3 flex items-center hover:scale-110 transition-transform duration-300"
                  ...
                  {showAnswers[question.qid] && (
                    <div>
                      <div className="ml-40 mt-12 text-right">
                        {answers
                          .filter(
                            (answer) => answer.question_id === question.qid
                          )
                          .map((answer) => (
                            <div>
                              ...
                              <div
                                key={answer.aid}
                                className="text-left mb-5 p-3 bg-[#ffe4e1] rounded-xl w-auto inline-block ml-auto"
                              >
                                ...
                                <div className="flex flex-row justify-end text-right">
                                  ...
                                  >
                                    <h5 className="p-1">
                                      {" "}
                                      {reactions[answer.aid] === undefined ||
                                      reactions[answer.aid].likeCount ===
                                        undefined
                                        ? 0
                                        : reactions[answer.aid].likeCount}{" "}
                                    </h5>
                                    ...
                                    className={`${
                                      reactions[answer.aid]?.disliked
                                        ...
                                        : "bg-red-300"
                                                            ...
                                                            `}
                                    onClick={() =>
                                      handleDislikeClick(answer.aid)
                                    }
                                  >
                                    <h5 className="p-1">
                                      {" "}
                                      {reactions[answer.aid] === undefined ||
                                      reactions[answer.aid].dislikeCount ===
                                        undefined
                                        ? 0
                                        : reactions[answer.aid]
                                            .dislikeCount}{" "}
                                    </h5>
                                    <img
                                      src="/dislike.png"
                                  ...
                                  <p className="text-sm text-red-600 m-3">
                                    {timeAgo(answer.time)}
                                  </p>
                                </div>
                              </div>
                      ...
                      <div className="flex flex-col items-center justify-end mt-8">
                        ...
                        ></textarea>
                        <button
                          className="bg-green-500 rounded w-15 h-4 p-3 m-3 flex items-center hover:scale-110 transition-transform duration-300"
                          onClick={async () => submitAnswer(question)}
                        >
                          submit
                        </button>
                      </div>
